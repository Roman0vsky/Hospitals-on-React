...
var DisplayMonths = function (_a) {
    ...
    var renderMonths = function () {
        ...
        return months.map(function (item) {
            return (jsx("div", __assign({ onClick: function () { return selectMonth(item); }, "data-testid": "month-item-to-select" }, { children: jsx("p", { children: item.format("MMMM") }) }), item.format("MM-MMMM")));
        });
    };
    return jsx(Wrapper$6, __assign({ className: "tp-calendar-month-select", jalali: jalali }, { children: renderMonths() }));
};
...
var DisplayYears = function (_a) {
    ...
    var _loop_1 = function (i) {
        years.push(jsx("p", __assign({ onClick: function () {
    ...
    return jsxs(Wrapper$5, __assign({ className: "tp-calendar-year-select", ref: ref }, { children: [" ", years, " "] }));
};
...
var Header = function (_a) {
    ...
    var _t = useState(false), displayYears = _t[0], setDisplayYears = _t[1];
    var prev = function () {
        if (displayMonths) {
    ...
    var renderTitles = function () {
        ...
        var titles = [];
        if (displayMonths) {
            return (jsxs(Fragment, { children: [jsx("p", __assign({ onClick: function () {
                            ...
                            : displayMonths
                                ? "YYYY"
                                : "YYYY-MMMM") })), displayYears && (jsx(DisplayYears, { setDisplayYears: setDisplayYears, setSource: setSource }))] }));
        }
    ...
    return (jsxs(Wrapper$4, __assign({ className: "tp-calendar-header", numberOfMonths: numberOfMonths, jalali: jalali, displayMonths: displayMonths }, { children: [jsxs("div", __assign({ className: ((_c = (_b = components === null || components === void 0 ? void 0 : components.header) === null || _b === void 0 ? void 0 : _b.monthIcons) === null || _c === void 0 ? void 0 : _c.left) ? "" : "action left", onClick: prev }, { children: [((_e = (_d = components === null || components === void 0 ? void 0 : components.header) === null || _d === void 0 ? void 0 : _d.monthIcons) === null || _e === void 0 ? void 0 : _e.left) &&
                        ...
                        displayMonths &&
                        components.header.yearIcons.left, !((_j = (_h = components === null || components === void 0 ? void 0 : components.header) === null || _h === void 0 ? void 0 : _h.monthIcons) === null || _j === void 0 ? void 0 : _j.left) && (jsxs(Fragment, { children: [jsx(SvgChevronLeft, {}), displayMonths ? jsx(SvgChevronLeft, {}) : null] }))] })), renderTitles(), jsxs("div", __assign({ className: ((_l = (_k = components === null || components === void 0 ? void 0 : components.header) === null || _k === void 0 ? void 0 : _k.monthIcons) === null || _l === void 0 ? void 0 : _l.right) ? "" : "action right", onClick: next }, { children: [((_o = (_m = components === null || components === void 0 ? void 0 : components.header) === null || _m === void 0 ? void 0 : _m.monthIcons) === null || _o === void 0 ? void 0 : _o.right) &&
                        !displayMonths &&
                        ...
                        displayMonths &&
                        components.header.yearIcons.right, !((_s = (_r = components === null || components === void 0 ? void 0 : components.header) === null || _r === void 0 ? void 0 : _r.monthIcons) === null || _s === void 0 ? void 0 : _s.right) && (jsxs(Fragment, { children: [jsx(SvgChevronRight, {}), displayMonths ? jsx(SvgChevronRight, {}) : null] }))] }))] })));
};
...
var TitleOfWeek = function (_a) {
    ...
    if (components === null || components === void 0 ? void 0 : components.wrapper) {
        ...
        return jsx(WrapperC, { jalali: jalali, startOfWeek: startOfWeek });
    }
    return (jsx(Wrapper$2, __assign({ className: "tp-calendar-week-titles", jalali: jalali, startOfWeek: startOfWeek }, { children: titles.map(function (item) { return (jsx("p", { children: item }, item)); }) })));
};
...
var Day$1 = function (_a) {
    ...
    return (jsxs(Wrapper$1, __assign({ "data-test": day.format(FORMAT_DATE), onClick: onClick, onMouseEnter: isMobile() ? undefined : hoverOnDay, className: classNames({
        ...
        }, extraDayClasses, "tp-calendar-day") }, { children: [DayComponent && (jsx(DayComponent, { day: day.format(FORMAT_DATE), jalali: jalali })), !DayComponent && day.format("DD")] })));
};
...
var Months$1 = function (_a) {
    ...
    var renderMonths = function () {
        ...
        var _loop_1 = function (i) {
            ...
            months.push(jsxs(Month, __assign({ className: "tp-calendar-month", numberOfMonths: numberOfMonths || 1, "data-test": dayjs().set("month", 1).set("day", 1).diff(source, "d") }, { children: [jsx(TitleOfWeek, { jalali: jalali, startOfWeek: startOfWeek, components: components === null || components === void 0 ? void 0 : components.titleOfWeek }), weeksDays.map(function (week) { return (jsx(Weeks, __assign({ className: "tp-calendar-week", jalali: jalali, "data-test": dayjs()
                            .set("month", 1)
                            .set("day", 1)
    ...
    return jsx(Wrapper$3, __assign({ className: "tp-calendar-months", jalali: jalali }, { children: renderMonths() }));
};
...
var RangePicker = function (_a) {
    ...
    var ref = useRef(null);
    var _o = useState(dayjsLocalized(jalali, initialMonthAndYear, locale)), source = _o[0], setSource = _o[1];
...
var Months = function (_a) {
    ...
    var renderMonths = function () {
        ...
        var _loop_1 = function (i) {
            ...
            months.push(jsxs(Month, __assign({ className: "tp-calendar-month", numberOfMonths: numberOfMonths || 1, "data-test": dayjs$1().set("month", 1).set("day", 1).diff(source, "d") }, { children: [jsx(TitleOfWeek, { jalali: jalali, startOfWeek: startOfWeek, components: components === null || components === void 0 ? void 0 : components.titleOfWeek }), weeksDays.map(function (week) { return (jsx(Weeks, __assign({ className: "tp-calendar-week", jalali: jalali, "data-test": dayjs$1()
                            .set("month", 1)
                            .set("day", 1)
